...
describe('tests for isValidJsonFormatValidator', () => {
  ...
  it('should return null when passing undefined', () => {
    expect(isValidJsonFormatValidator(new FormControl(undefined))).toEqual(null);
  });
  ...
  it('should return error when passing only opening bracket', () => {
    expect(isValidJsonFormatValidator(new FormControl('{'))).toEqual({invalidJsonFormat: true});
  });
  ...
  it('should return null when passing an object with properties as a string', () => {
    expect(isValidJsonFormatValidator(new FormControl('{"result":true, "count":42}'))).toEqual(null);
  });

  it('should return error when passing an bad object with props as a string', () => {
    expect(isValidJsonFormatValidator(new FormControl('{"result":true, "count":42')))
