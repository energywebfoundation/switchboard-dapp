...
describe('HistoryPeriodComponent', () => {
  ...
  beforeEach(() => {
    ...
    historyElement = fixture.nativeElement.querySelectorAll('app-history-element');
  ...
  it('should compare history part when period have event Asset_transferred', () => {
    ...
    expect(component.getTopPart()).toEqual(jasmine.objectContaining({ header: 'Offered from', element: 'relatedTo' }));
    expect(component.getBottomPart()).toEqual(jasmine.objectContaining({ header: 'Owner', element: 'emittedBy' }));
  });
  ...
  it('should compare history part when perdiod event is not equal to Asset_transferred', () => {
    ...
    expect(component.getTopPart()).toEqual(jasmine.objectContaining({ header: 'Owner', element: 'emittedBy' }));
    expect(component.getBottomPart()).toEqual(jasmine.objectContaining({ header: 'Offered to', element: 'relatedTo' }));
  });
