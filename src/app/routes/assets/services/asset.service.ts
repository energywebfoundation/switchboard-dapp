...
const REGISTER_ASSET_ERROR =
  'Could not register asset at this time. Please contact system administrator';
...
export class AssetService {
  ...
  register() {
    return this.iamService
      .wrapWithLoadingService(this.iamService.registerAsset(), {
