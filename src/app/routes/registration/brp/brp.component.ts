...
@Component({
    selector: 'app-brp',
    templateUrl: './brp.component.html',
    styleUrls: ['./brp.component.scss']
})
export class BrpComponent implements OnInit {
    ...
    ngOnInit() {
        this.route.queryParamMap.subscribe(params => {
            this.formGroupRegister = createFormGroupRegister({ organizationType: params.get('organizationType')});
        });
